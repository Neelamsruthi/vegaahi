  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start bg-gradient-to-br from-purple-50 to-pink-50 px-6 py-16">
      ...
      <div className="flex gap-4 justify-center mb-12">
        <Link to="/student/profile" className="bg-purple-300 text-purple-900 px-6 py-2 rounded-lg shadow-sm hover:bg-purple-400 transition">
          Profile
        </Link>
        <Link to="/student/quizzes" className="bg-pink-300 text-pink-900 px-6 py-2 rounded-lg shadow-sm hover:bg-pink-400 transition">
          Start Quiz
        </Link>
      </div>
